...
The median `wieght` of `physical_3plus==yes` is larger, and there are more extreme `weight` of `physical_3plus==no`. I expected the median `wieght` of `physical_3plus==yes` is smaller because they tended to consume more energy.
...
ggplot(plot2, aes(x=maturity, y=price, colour=year))+
